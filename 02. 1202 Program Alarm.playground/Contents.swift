...
func compute(program: Memory, noun: MemoryValue, verb: MemoryValue) -> MemoryValue {
...
print(compute(program: program, noun: 12, verb: 02))
//12490719
...
let noun = (0...99).first(where: { compute(program: program, noun: $0 + 1, verb: 0) > desiredOutput })!
let verb = (0...99).first(where: { compute(program: program, noun: noun, verb: $0) == desiredOutput })!
