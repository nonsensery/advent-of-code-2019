...
public protocol _IntcomputerInput {
    mutating func read() -> Intcomputer.Value?
}

public protocol _IntcomputerOutput {
    mutating func write(_ value: Intcomputer.Value)
}

public struct Intcomputer {
    ...
    public typealias Input = _IntcomputerInput
    public typealias Output = _IntcomputerOutput
    ...
    public var input: Input = Pipe()
    public var output: Output = Pipe()
